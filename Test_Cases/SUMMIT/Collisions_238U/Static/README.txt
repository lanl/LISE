The file explains how to generate coordinate space solutions for an U238+U238 system from input densities using the LISE static solver. The output wfs can be used as inputs for a time dependent nuclear collisions simulations.
...
The input_file.txt defines the parameters of the simulation:
	...
	nz 64 -- the number of lattice sites along the z direction.
	...
	N 292 -- number of neutrons.
	Z 184 -- number of protons.
...
The myjob.lsf file is a script used to run the job (will change depending on system). In the jsrun command line:
	...
	jsrun -n 3864 -a 1 -g 0 ./lise-static input_file.txt > U238.out
